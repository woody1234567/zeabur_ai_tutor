...
// Favorite Logic
const isFavorite = ref(problem.value?.isFavorite ?? false);
        ...
        <div class="flex justify-between items-start gap-2">
          ...
          <div class="flex items-center gap-2 flex-wrap justify-end">
            ...
            <button
              ...
              :title="isFavorite ? $t('student.problems.remove_from_favorites') : $t('student.problems.add_to_favorites')"
              :disabled="isTogglingFavorite"
              @click="toggleFavorite"
            >
              <span v-if="isTogglingFavorite" class="loading loading-spinner loading-xs"></span>
              <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" :fill="isFavorite ? 'currentColor' : 'none'" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
